...
//4. Declarar un vector miVec1[3] de tipo byte, y asignamos el numero 0 a las posiciones 0, 1, 2 y 3.
		byte miVec1[] = new byte [3];
		miVec1[0] = 0;
		miVec1[1] = 0;
		miVec1[2] = 0;
		//miVec1[3] = 0; Esta es una mala asignacion porque la posicion 3 esta fuera de rango.
		
/*5. Declarar un vector miVec2[3] de tipo char, y asignamos la letra A a las posiciones 0 y 1; 
y a la posicion 2 la letra B finalmente imprimir las posiciones 0 y 2.*/
		...
		System.out.print("Todo el vector: ");
